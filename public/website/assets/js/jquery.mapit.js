...
//address: '<h2>The India Cements Limited</h2><p>Sankarnagar P.O., Tirunelveli District, Tamil Nadu, Pincode:627357 </p><p>Tel.: 0462 2300221<br />Fax: 0462 2300294</p>',
			styles: 'GRAYSCALE',
			locations: [
				[13.044099841270507, 80.24058623870108, 'http://192.168.0.56/gericare/public/website/assets/images/marker.png', '', '<div class="plantimg clearfix"><img src="http://192.168.0.56/gericare/public/website/assets/images/hospital.jpg"/></div><h2 style="font-weight: 700;font-size: 18px;color: #7C164B;margin: 15px 0px 10px;line-height: 20px;">Geri Care Hospital T.Nagar</h2> '], 
				
				[12.983293353115576, 80.20030574475071, 'http://192.168.0.56/gericare/public/website/assets/images/marker.png', '', '<div class="plantimg clearfix"><img src="http://192.168.0.56/gericare/public/website/assets/images/hospital.jpg"/></div><h2 style="font-weight: 700;font-size: 18px;color: #7C164B;margin: 15px 0px 10px;line-height: 20px;">Geri Care Hospital Velachery</h2> '], 
				
				[12.99958788041761, 80.25408423851532, 'http://192.168.0.56/gericare/public/website/assets/images/marker.png', '', '<div class="plantimg clearfix"><img src="http://192.168.0.56/gericare/public/website/assets/images/hospital.jpg"/></div><h2 style="font-weight: 700;font-size: 18px;color: #7C164B;margin: 15px 0px 10px;line-height: 20px;">Geri Care Clinics Adyar</h2> '], 
				
				[13.091367237211617, 80.21792048269542, 'http://192.168.0.56/gericare/public/website/assets/images/marker.png', '', '<div class="plantimg clearfix"><img src="http://192.168.0.56/gericare/public/website/assets/images/hospital.jpg"/></div><h2 style="font-weight: 700;font-size: 18px;color: #7C164B;margin: 15px 0px 10px;line-height: 20px;">Geri Care Clinics Anna nagar</h2> '], 
				
				[12.944290642801182, 80.24030833851451, 'http://192.168.0.56/gericare/public/website/assets/images/marker.png', '', '<div class="plantimg clearfix"><img src="http://192.168.0.56/gericare/public/website/assets/images/hospital.jpg"/></div><h2 style="font-weight: 700;font-size: 18px;color: #7C164B;margin: 15px 0px 10px;line-height: 20px;">Geri Care Assisted Living Thoraipakkam</h2> '], 
				
				[13.024349991142719, 80.25585876735146, 'http://192.168.0.56/gericare/public/website/assets/images/marker.png', '', '<div class="plantimg clearfix"><img src="http://192.168.0.56/gericare/public/website/assets/images/hospital.jpg"/></div><h2 style="font-weight: 700;font-size: 18px;color: #7C164B;margin: 15px 0px 10px;line-height: 20px;">Geri Care Assisted Living RA Puram</h2> ']
