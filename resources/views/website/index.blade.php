...
<div id="homeCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-touch="true" >
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item active">
      <img src="{{ asset('/public/website/assets/images/banners/banner-image1.jpg') }}" alt="" class="desky w-100 d-none d-lg-block" />
      <img src="{{ asset('/public/website/assets/images/banners/banner-image1-mobile.jpg') }}" alt="" class="desky w-100 d-block d-lg-none" />
      
      <img src="{{ asset('/public/website/assets/images/banners/banner-image1-mobile-1.jpg') }}" alt="" class="moby w-100 d-block d-lg-none" />
...
<div class="carousel-item">
  <img src="{{ asset('/public/website/assets/images/banners/banner-image2.jpg') }}" alt="" class="w-100 d-none d-lg-block" />
  <img src="{{ asset('/public/website/assets/images/banners/banner-image2-mobile.jpg') }}" alt="" class="w-100 d-block d-lg-none" />
  <div class="carousel-caption animated animatedFadeInUp fadeInUp">
    <h1 class="text-blue">Come Home to Love, Warmth & Skilled Nursing Care</h1>
    <span class="text-blue">India’s First Multi-speciality hospital for Senior Citizens.</span>
...
<div class="carousel-item">
  <img src="{{ asset('/public/website/assets/images/banners/banner-image3.jpg') }}" alt="" class="w-100 d-none d-lg-block" />
  <img src="{{ asset('/public/website/assets/images/banners/banner-image3-mobile.jpg') }}" alt="" class="w-100 d-block d-lg-none" />
  <div class="carousel-caption animated animatedFadeInUp fadeInUp">
    <h1 class="text-blue">Come Home to Love, Warmth & Skilled Nursing Care</h1>
    <span class="text-blue">India’s First Multi-speciality hospital for Senior Citizens.</span>
...
<img src="{{ asset('/public/website/assets/images/degree-1.png') }}" alt="" class="w-100">
</div>
</div>
...
<div class="col-lg-6 p-0">
<div class="full-deg-img">
<img src="{{ asset('/public/website/assets/images/degree-2.png') }}" alt="" class="w-100">
</div>
</div>
...
<div class="col-lg-6 p-0">
<div class="full-deg-img">
<img src="{{ asset('/public/website/assets/images/degree-3.png') }}" alt="" class="w-100">
</div>
</div>
...
<div class="col-lg-6 p-0">
<div class="full-deg-img">
<img src="{{ asset('/public/website/assets/images/degree-4.png') }}" alt="" class="w-100">
</div>
</div>
...
<div class="d-flex align-items-start">
  ...
  <div class="tab-content" id="v-pills-tabContent">
    ...
    <span>Our geriatric hospital is open 24x7 with round-the-clock staff to provide care and support for elderly patients.</span>  
    </div>
    </div>
    ...
    <div class="skills-img">
    <img src="{{ asset('/public/website/assets/images/hospitalo-2.jpg') }}" alt="" class="w-100">
    <div class="skills-cnt">
    <span>Our geriatric hospital is open 24x7 with round-the-clock staff to provide care and support for elderly patients.</span>  
    </div>
    </div>
    ...
    <div class="skills-img">
    <img src="{{ asset('/public/website/assets/images/hospitalo-3.jpg') }}" alt="" class="w-100">
    <div class="skills-cnt">
    <span>Our geriatric hospital is open 24x7 with round-the-clock staff to provide care and support for elderly patients.</span>  
    </div>
    </div>
    ...
    <div class="skills-img">
    <img src="{{ asset('/public/website/assets/images/hospitalo-4.jpg') }}" alt="" class="w-100">
    <div class="skills-cnt">
    <span>Our geriatric hospital is open 24x7 with round-the-clock staff to provide care and support for elderly patients.</span>  
    </div>
    </div>
...
<p>According to Indian Ageing Report 2017, 12 crore adults – almost the population of Japan – are above…</p>
<a href="https://www.gericare.in/blog/" target="_blank">Read More <img src="{{ asset('/public/website/assets/images/red.png') }}" alt="" class="" /></a>
</div>
</div> 
...
<p>This is the question that lingers around in the minds of young senior citizens. By young, I mean the population who have just got retired and entered the 60s. </p>
<a href="https://www.gericare.in/blog/" target="_blank">Read More <img src="{{ asset('/public/website/assets/images/red.png') }}" alt="" class="" /></a>
</div>
</div> 
...
<p>We know what it feels like to leave aging parents home alone during an important official visit. We know that it takes years of trust ...</p>
<a href="https://www.gericare.in/blog/" target="_blank">Read More <img src="{{ asset('/public/website/assets/images/red.png') }}" alt="" class="" /></a>
</div>
</div> 
...
<div class="ger-care">
<img src="{{ asset('/public/website/assets/images/care-1.jpg') }}" alt="" class="w-100">
