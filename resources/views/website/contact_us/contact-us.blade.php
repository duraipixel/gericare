...
<p> AKS RESIDENCY, Balamurugan Garden,<br> 1st main road, Thoraipakkam,<br> Chennai - 600 097 </p>
<a href=""> Locate Us <img src="{{ asset('/public/website/assets/images/small-arr.png') }}" alt="" class="" /></a>
</div>
